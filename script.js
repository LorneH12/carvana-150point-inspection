...
const TRANSLATIONS = {
  en: {
    ...
    "flow.body":
      "Content coming soon. This section will walk through how vehicles move through the recon center from arrival to final quality checks.",

    "quality.heading": "Section Three: Quality & Safety",
    "quality.body":
      "Content coming soon. This section will focus on final inspection checks, documentation, and how to escalate any safety concerns."
  },
  ...
  es: {
    ...
    "flow.body":
      "Contenido próximamente. Esta sección explicará cómo se mueven los vehículos por el centro de reacondicionamiento desde su llegada hasta las verificaciones finales.",

    "quality.heading": "Sección Tres: Calidad y Seguridad",
    "quality.body":
      "Contenido próximamente. Esta sección se centrará en las revisiones finales de inspección, la documentación y cómo escalar cualquier inquietud de seguridad."
  },
  ...
  zh: {
    ...
    "flow.body":
      "内容即将上线。本部分将介绍车辆从到店到最终质量检查的完整流程。",

    "quality.heading": "第三部分：质量与安全",
    "quality.body":
      "内容即将上线。本部分将聚焦最终检查、记录以及如何上报任何安全隐患。"
  }
};
